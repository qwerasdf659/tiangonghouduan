...
// 备份配置
const BACKUP_DIR = path.join(__dirname, '..', '..', 'backups', 'backup_2025-12-27')
...
async function performFullBackup() {
  ...
  try {
    ...
    // SQL备份内容
    let sqlContent = `-- ============================================\n`
    sqlContent += `-- 2025年12月27日 完整数据库备份\n`
    ...
    const sqlFile = path.join(BACKUP_DIR, `full_backup_2025-12-27_${timestamp}.sql`)
    const jsonFile = path.join(BACKUP_DIR, `full_backup_2025-12-27_${timestamp}.json`)
