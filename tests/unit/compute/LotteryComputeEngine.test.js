 ...
 * 5. 边界场景测试
 *
 * @module tests/unit/compute/LotteryComputeEngine.test
 */
...
describe('LotteryComputeEngine', () => {
  ...
  describe('初始化', () => {
    test('创建实例成功', () => {
      expect(engine).toBeInstanceOf(LotteryComputeEngine)
    })
  ...
  describe('单例模式', () => {
    test('getComputeEngine 返回单例', () => {
      const engine1 = getComputeEngine()
      const engine2 = getComputeEngine()
