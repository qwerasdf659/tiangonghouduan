...
│   │   ├── GET  /api/v4/unified-engine/consumption/qrcode/:user_id
│   │   ├── POST /api/v4/unified-engine/consumption/validate-qrcode
│   │   ├── POST /api/v4/unified-engine/consumption/submit
│   │   └── GET  /api/v4/unified-engine/consumption/user/:user_id
│   │
