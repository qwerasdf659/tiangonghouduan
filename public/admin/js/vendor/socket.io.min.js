...
!(function (t, e) {
  ...
  for (
    var T = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/',
      R = typeof Uint8Array === 'undefined' ? [] : new Uint8Array(256),
      C = 0;
    C < 64;
    C++
  )
  ...
  function U(t) {
    if (t)
      return (function (t) {
        for (const e in U.prototype) t[e] = U.prototype[e]
        return t
      })(t)
  }
  ...
  const M = I.setTimeout
  const V = I.clearTimeout
  function H(t, e) {
    e.useNativeTimers
  ...
  function nt(t) {
    const e = t.xdomain
    try {
      if (typeof XMLHttpRequest !== 'undefined' && (!e || et)) return new XMLHttpRequest()
    } catch (t) {}
    if (!e)
      try {
  ...
  function rt() {}
  const it = new nt({ xdomain: !1 }).responseType != null
  const ot = (function (t) {
    o(s, t)
    const n = l(s)
    function s(t) {
      ...
      if ((e(this, s), ((r = n.call(this, t)).polling = !1), typeof location !== 'undefined')) {
        ...
        ;(o || (o = i ? '443' : '80'),
          (r.xd =
            (typeof location !== 'undefined' && t.hostname !== location.hostname) || o !== t.port))
      }
        ...
        },
        {
          ...
          value: function (t) {
            ...
            ;((function (t, e) {
              ...
              if (
                (e.readyState === 'opening' && t.type === 'open' && e.onOpen(), t.type === 'close')
              )
      ...
      r(i, [
        {
          ...
          value: function () {
            ...
            const r = (this.xhr = new nt(n))
            try {
              r.open(this.method, this.uri, !0)
              try {
                if (this.opts.extraHeaders)
                  for (const o in (r.setDisableHeaderCheck && r.setDisableHeaderCheck(!0),
              ...
              ;((t = this.opts.cookieJar) === null || void 0 === t || t.addCookies(r),
                ...
                (r.onreadystatechange = function () {
                  let t
                  ;(r.readyState === 3 &&
                    ((t = e.opts.cookieJar) === null || void 0 === t || t.parseCookies(r)),
                    r.readyState === 4 &&
  ...
  if (((st.requestsCount = 0), (st.requests = {}), typeof document !== 'undefined'))
    if (typeof attachEvent === 'function') attachEvent('onunload', at)
    else if (typeof addEventListener === 'function') {
      addEventListener('onpagehide' in I ? 'pagehide' : 'unload', at, !1)
    }
  function at() {
    for (const t in st.requests) st.requests.hasOwnProperty(t) && st.requests[t].abort()
  }
  const ut =
  ...
  const ct = I.WebSocket || I.MozWebSocket
  const ht =
            ...
            typeof WebTransport === 'function' &&
              ...
              this.transport.ready.then(function () {
                t.transport.createBidirectionalStream().then(function (e) {
                      ...
                      transform: function (s, a) {
                        for (n.push(s); ; ) {
                          if (r === 0) {
                            ...
                            if (j(n) < 8) break
                            const h = D(n, 8)
                            const f = new DataView(h.buffer, h.byteOffset, h.length)
                            const l = f.getUint32(0)
                  ...
                  const r = e.readable.pipeThrough(n).getReader()
                  const i = q()
  ...
  const pt = { websocket: ft, webtransport: lt, polling: ot }
  const dt =
  ...
  const gt = (function (n) {
    ...
    function a(n) {
      ...
      return (
        ...
        (r.hostname =
          o.hostname || (typeof location !== 'undefined' ? location.hostname : 'localhost')),
        (r.port =
          o.port ||
  ...
  const mt = typeof ArrayBuffer === 'function'
  const bt = function (t) {
    return typeof ArrayBuffer.isView === 'function'
      ? ArrayBuffer.isView(t)
  ...
  const wt =
    typeof Blob === 'function' ||
    (typeof Blob !== 'undefined' && kt.call(Blob) === '[object BlobConstructor]')
  const _t =
    typeof File === 'function' ||
    (typeof File !== 'undefined' && kt.call(File) === '[object FileConstructor]')
  function At(t) {
    return (
  ...
  function Ot(e, n) {
    ...
    if (Array.isArray(e)) {
      for (let r = 0, i = e.length; r < i; r++) if (Ot(e[r])) return !0
      return !1
    }
    if (At(e)) return !0
    if (e.toJSON && typeof e.toJSON === 'function' && arguments.length === 1)
      return Ot(e.toJSON(), !0)
    for (const o in e) if (Object.prototype.hasOwnProperty.call(e, o) && Ot(e[o])) return !0
    return !1
  }
  function Et(t) {
    const e = []
  ...
  function Tt(e, n) {
    ...
    if (t(e) === 'object' && !(e instanceof Date)) {
      const s = {}
      for (const a in e) Object.prototype.hasOwnProperty.call(e, a) && (s[a] = Tt(e[a], n))
      return s
    }
    return e
  }
  ...
  function Ct(e, n) {
    ...
    if (Array.isArray(e)) for (let r = 0; r < e.length; r++) e[r] = Ct(e[r], n)
    else if (t(e) === 'object')
      for (const i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = Ct(e[i], n))
    return e
  }
  let Bt
  const St = [
        ...
        [
          {
            ...
            value: function (t) {
              ...
              if (typeof t === 'string') {
                ...
                const n = (e = this.decodeString(t)).type === Bt.BINARY_EVENT
              ...
              switch (t) {
                ...
                case Bt.BINARY_EVENT:
                  return (
                    Array.isArray(e) &&
                    (typeof e[0] === 'number' ||
                      (typeof e[0] === 'string' && St.indexOf(e[0]) === -1))
                  )
                case Bt.ACK:
                case Bt.BINARY_ACK:
      ...
      r(t, [
        {
          ...
          value: function (t) {
            if ((this.buffers.push(t), this.buffers.length === this.reconPack.attachments)) {
              const e = Rt(this.reconPack, this.buffers)
      ...
      r(a, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            const i = { type: Bt.EVENT, data: n, options: {} }
            if (
          ...
          value: function (t, e) {
            ...
            if (void 0 !== i) {
              const o = this.io.setTimeoutFn(function () {
                delete r.acks[t]
                for (let n = 0; n < r.sendBuffer.length; n++)
        ...
        },
        {
          ...
          value: function (t) {
            ...
            ;(t.push(function (t) {
              if (r === n._queue[0]) {
                if (t !== null) r.tryCount > n._opts.retries && (n._queue.shift(), e && e(t))
      ...
      r(s, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            const s = jt(n, 'error', o)
            if (!1 !== this._timeout) {
              const a = this._timeout
              const u = this.setTimeoutFn(function () {
