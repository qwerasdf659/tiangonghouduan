...
!(function (e, t) {
  ...
  function H(e, t) {
    t.useNativeTimers
      ...
      : ((e.setTimeoutFn = I.setTimeout.bind(I)), (e.clearTimeoutFn = I.clearTimeout.bind(I)))
  }
  var K,
    Y = (function (e) {
      o(i, e)
        ...
        r(i, [
          {
            ...
            value: function (e, t, n) {
              return (
                p(s(i.prototype), 'emitReserved', this).call(this, 'error', new Y(e, t, n)),
                this
              )
            }
          },
    ...
    oe = (function (e) {
      ...
      function s(e) {
        ...
        if ((t(this, s), ((r = n.call(this, e)).polling = !1), 'undefined' != typeof location)) {
          ...
          ;(o || (o = i ? '443' : '80'),
            (r.xd =
              ('undefined' != typeof location && e.hostname !== location.hostname) || o !== e.port))
        }
              ...
              try {
                ...
                ;(null === (e = this.opts.cookieJar) || void 0 === e || e.addCookies(r),
                  ...
                  (r.onreadystatechange = function () {
                    var e
                    ;(3 === r.readyState &&
                      (null === (e = t.opts.cookieJar) || void 0 === e || e.parseCookies(r)),
                      4 === r.readyState &&
        ...
        r(a, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++)
                n[r - 1] = arguments[r]
              if (
                (n.unshift(e), this._opts.retries && !this.flags.fromQueue && !this.flags.volatile)
              )
          ...
          },
          {
            ...
            value: function (e) {
              this.packet({
                type: Be.CONNECT,
                data: this._pid ? i({ pid: this._pid, offset: this._lastOffset }, e) : e
              })
            }
          },
          {
