  ...
  try {
    ...
    if (sampleData.length === 0) {
      ...
      sampleData.forEach(row => {
        ...
        console.log(`   [${row.category}] ${row.setting_key} = ${value}... (${row.value_type}) ${row.is_visible ? '可见' : '隐藏'}`)
      })
    }
    ...
    if (totalSettings === 0) {
      ...
      const testSettings = [
        { category: 'basic', setting_key: 'system_name', setting_value: '餐厅积分抽奖系统', value_type: 'string', description: '系统名称', is_visible: 1, is_readonly: 0 },
        { category: 'basic', setting_key: 'system_version', setting_value: '4.0.0', value_type: 'string', description: '系统版本', is_visible: 1, is_readonly: 1 },
        { category: 'basic', setting_key: 'maintenance_mode', setting_value: 'false', value_type: 'boolean', description: '维护模式开关', is_visible: 1, is_readonly: 0 },
        { category: 'basic', setting_key: 'maintenance_message', setting_value: '系统正在升级维护中', value_type: 'string', description: '维护公告', is_visible: 1, is_readonly: 0 },
        { category: 'points', setting_key: 'lottery_cost_points', setting_value: '100', value_type: 'number', description: '单次抽奖消耗积分', is_visible: 1, is_readonly: 0 },
        { category: 'points', setting_key: 'daily_lottery_limit', setting_value: '10', value_type: 'number', description: '每日抽奖次数限制', is_visible: 1, is_readonly: 0 },
        { category: 'security', setting_key: 'enable_captcha', setting_value: 'true', value_type: 'boolean', description: '启用验证码', is_visible: 1, is_readonly: 0 },
        { category: 'security', setting_key: 'max_login_attempts', setting_value: '5', value_type: 'number', description: '最大登录尝试次数', is_visible: 1, is_readonly: 0 },
        { category: 'notification', setting_key: 'enable_sms', setting_value: 'false', value_type: 'boolean', description: '启用短信通知', is_visible: 1, is_readonly: 0 },
        { category: 'notification', setting_key: 'enable_push', setting_value: 'true', value_type: 'boolean', description: '启用推送通知', is_visible: 1, is_readonly: 0 }
      ]
