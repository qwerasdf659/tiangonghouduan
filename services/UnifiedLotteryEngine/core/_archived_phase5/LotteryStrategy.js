...
class LotteryStrategy {
  ...
  recordMetrics(executionTime, success) {
    ...
    const count = this.metrics.execution_count
    this.metrics.average_execution_time = (currentAvg * (count - 1) + executionTime) / count

    this.metrics.last_executed_at = this.getBeijingTime()
  }
