...
module.exports = {
  ...
  async up(queryInterface, Sequelize) {
    ...
    const popupBanners = [
      {
        title: '[测试]新春活动弹窗',
        image_url: 'test-seeds/banners/spring-festival.jpg',
        display_mode: 'square',
        image_width: 750,
        image_height: 750,
        link_url: '/pages/lottery/index',
        link_type: 'page',
        position: 'home',
        is_active: true,
        display_order: 1,
        start_time: now,
        end_time: new Date(now.getTime() + 30 * 24 * 3600 * 1000),
        banner_type: 'event',
      ...
      {
        title: '[测试]系统维护公告',
        image_url: 'test-seeds/banners/maintenance-notice.jpg',
        display_mode: 'wide',
        image_width: 750,
        image_height: 420,
        link_url: null,
        ...
        display_order: 0,
        start_time: now,
        end_time: new Date(now.getTime() + 3 * 24 * 3600 * 1000),
        banner_type: 'notice',
      ...
      {
        title: '[测试]限时折扣弹窗',
        image_url: 'test-seeds/banners/flash-sale.jpg',
        display_mode: 'tall',
        image_width: 750,
        image_height: 1000,
        link_url: '/pages/exchange/index',
        link_type: 'page',
        position: 'home',
        is_active: true,
        display_order: 2,
      ...
      {
        title: '[测试]个人中心推广',
        image_url: 'test-seeds/banners/profile-promo.jpg',
      ...
      {
        title: '[测试]已禁用弹窗',
        image_url: 'test-seeds/banners/disabled-banner.jpg',
        display_mode: 'wide',
        image_width: 750,
        image_height: 420,
        link_url: null,
    ...
    const carouselItems = [
      {
        title: '[测试]首页轮播-新品上线',
        image_url: 'test-seeds/carousel/new-arrivals.jpg',
        display_mode: 'wide',
        image_width: 750,
        image_height: 420,
        link_url: '/pages/exchange/index?tab=new',
        link_type: 'page',
        position: 'home',
        is_active: true,
        display_order: 1,
      ...
      {
        title: '[测试]首页轮播-每日抽奖',
        image_url: 'test-seeds/carousel/daily-lottery.jpg',
        display_mode: 'wide',
        image_width: 750,
        image_height: 420,
        link_url: '/pages/lottery/index',
      ...
      {
        title: '[测试]首页轮播-臻选空间',
        image_url: 'test-seeds/carousel/premium-space.jpg',
        display_mode: 'wide',
        image_width: 750,
        image_height: 420,
        link_url: '/pages/exchange/index?space=premium',
        link_type: 'page',
        position: 'home',
        is_active: true,
        display_order: 3,
      ...
      {
        title: '[测试]首页轮播-已过期',
        image_url: 'test-seeds/carousel/expired-promo.jpg',
        display_mode: 'wide',
        image_width: 750,
        image_height: 420,
        link_url: null,
        ...
        end_time: new Date(now.getTime() - 1 * 24 * 3600 * 1000),
        created_by: adminUserId,
        created_at: now,
        updated_at: now
      },
      {
        title: '[测试]首页轮播-已禁用',
        image_url: 'test-seeds/carousel/disabled-slide.jpg',
        display_mode: 'horizontal',
        image_width: 750,
        image_height: 500,
        link_url: null,
    ...
    const announcements = [
      {
        title: '[测试]系统升级维护通知',
        content:
          '尊敬的用户，系统将于2026年2月20日凌晨2:00-6:00进行升级维护，届时服务将暂时不可用，请提前做好准备。给您带来不便，敬请谅解！',
        type: 'maintenance',
        priority: 'high',
        target_groups: JSON.stringify(['all']),
        internal_notes: JSON.stringify({ reason: '数据库迁移升级' }),
        is_active: true,
      ...
      },
      {
        title: '[测试]春节活动上线',
        content:
          '🧨 新春水晶大作战活动正式上线！活动期间参与抽奖可获得双倍水晶碎片奖励，更有限定纪念徽章等你来拿！活动时间：2月15日-3月1日。',
        type: 'activity',
        priority: 'medium',
        target_groups: JSON.stringify(['all']),
        internal_notes: null,
        is_active: true,
        expires_at: new Date(now.getTime() + 14 * 24 * 3600 * 1000),
        admin_id: adminUserId,
        view_count: 432,
        created_at: now,
        updated_at: now
      ...
      {
        title: '[测试]安全提醒',
        content: '请注意保护您的账号安全，不要将验证码分享给他人。如发现异常登录，请立即联系客服。',
        type: 'notice',
        priority: 'low',
        target_groups: JSON.stringify(['all']),
        internal_notes: null,
  ...
  async down(queryInterface, _Sequelize) {
    ...
    await queryInterface.bulkDelete('system_announcements', {
      title: { [_Sequelize.Op.like]: `${testPrefix}%` }
    })
    await queryInterface.bulkDelete('carousel_items', {
      title: { [_Sequelize.Op.like]: `${testPrefix}%` }
    })
    await queryInterface.bulkDelete('popup_banners', {
      title: { [_Sequelize.Op.like]: `${testPrefix}%` }
    })
