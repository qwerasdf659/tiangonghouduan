...
) ENGINE=InnoDB AUTO_INCREMENT=587 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='竞价记录表 — Phase 4 竞价排名';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=381 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='广告投放计划表 — Phase 3 广告主自助投放';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=367 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='广告素材表 — Phase 3 素材审核';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=252 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='通用内容交互日志表 — 统一记录弹窗/轮播/公告/广告的展示、点击、关闭等交互事件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='每日报表快照表 — Phase 6 凌晨4点聚合';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=74146 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员通知消息表 - 存储系统通知、告警提醒、任务通知等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='行政区划字典表（省市区街道数据，支持级联选择）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `api_idempotency_requests`
--

DROP TABLE IF EXISTS `api_idempotency_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4033416 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='API入口幂等表 - 实现重试返回首次结果';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='审核链节点定义';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=163421 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资产流水表（Asset Transactions）- 记录所有资产变动流水，支持幂等性控制和审计追溯';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=298 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='品类树（EAV 商品中心 Layer 1）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22852 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='聊天消息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=575 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='兑换渠道定价（Layer 2，管理SKU在兑换商城的材料资产价格）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='兑换订单状态变更事件表（审计追踪）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `exchange_records` (
  ...
  `user_id` int NOT NULL COMMENT '用户ID',
  `exchange_item_id` bigint DEFAULT NULL COMMENT '关联兑换商品 SPU（DIY 兑换为 NULL）',
  ...
  `address_snapshot` json DEFAULT NULL COMMENT '下单时收货地址快照（JSON：receiver_name, receiver_phone, province, city, district, detail_address）',
  ...
  CONSTRAINT `exchange_records_exchange_item_id_fk` FOREIGN KEY (`exchange_item_id`) REFERENCES `exchange_items` (`exchange_item_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=1518 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='兑换市场记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='外部平台商品ID↔我方item_code映射(S5)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3628 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='功能开关表（Feature Flag）- 全系统通用灰度发布控制';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=431 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户反馈表 - 支持客服反馈功能';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lottery_campaigns` (
  ...
  `entry_asset_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'points' COMMENT '抽奖入场资产码(扣费货币):points=全局可见积分(默认,常驻活动)/event_points=活动专属代币(限时活动,按EVENT_<campaign_code>桶隔离到期清零);软业务码,收口constants/AssetCode.js',
...
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='抽奖日报统计表（按日聚合，永久保留，用于长期历史分析）';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `lottery_draw_decisions`
--

DROP TABLE IF EXISTS `lottery_draw_decisions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10271 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='抽奖决策快照表 - 记录每次抽奖的完整决策路径用于审计';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lottery_draws` (
  ...
  `prize_type` enum('material','item','coupon','points') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '奖品类型（统一词表，与 prize_definitions 一致：material/item/coupon/points）',
  ...
  KEY `idx_lottery_draws_campaign_prize` (`lottery_campaign_prize_id`),
  CONSTRAINT `fk_lottery_draws_campaign_prize` FOREIGN KEY (`lottery_campaign_prize_id`) REFERENCES `lottery_campaign_prizes` (`lottery_campaign_prize_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
-- Table structure for table `lottery_simulation_records`
--

DROP TABLE IF EXISTS `lottery_simulation_records`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `lottery_simulation_records` (
...
) ENGINE=InnoDB AUTO_INCREMENT=667 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='策略效果模拟记录表 — 保存模拟参数、结果、对比、风险评估和偏差追踪';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lottery_tier_matrix_config` (
  ...
  `lottery_campaign_id` int NOT NULL COMMENT '关联的抽奖活动ID（支持多活动策略隔离）',
  `budget_tier` enum('ALL') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ALL' COMMENT '预算档位（Pressure Tier 重构后固定 ALL，矩阵仅按 pressure_tier 维度配置）',
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='媒体关联表（多态关联 - 独立媒体服务方案 D+ 增强版）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='媒体文件表（纯存储层 - 独立媒体服务方案 D+ 增强版）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家信息表（多商家接入：餐厅/商铺/小游戏/服务商）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operation_logs` (
  `operation_log_id` bigint NOT NULL AUTO_INCREMENT COMMENT '操作日志ID（主键，自增）',
  `operator_type` enum('admin','merchant','batch') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '日志域：admin=管理员单笔操作审计 | merchant=商家员工操作 | batch=管理员批量任务',
  `operator_id` int NOT NULL COMMENT '操作员ID（管理员/商家员工 user_id）',
  `store_id` int DEFAULT NULL COMMENT '门店ID（merchant 域：操作发生的门店；admin/batch 域为 NULL）',
  `operation_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '操作类型（admin 域见 constants/AuditOperationTypes.js；merchant/batch 域见模型导出常量）',
  `action` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作动作（admin/merchant 域使用；batch 域为 NULL）',
  `target_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '目标对象类型（统一 snake_case 资源码）',
  `target_id` bigint DEFAULT NULL COMMENT '目标对象ID（与 target_type 配套）',
  `status` enum('success','failed','blocked','processing','partial_success','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'success' COMMENT '统一状态：admin 固定 success；merchant success/failed/blocked；batch processing/partial_success/completed/failed',
  `before_data` json DEFAULT NULL COMMENT '操作前数据（admin 域）',
  `after_data` json DEFAULT NULL COMMENT '操作后数据（admin 域）',
  `changed_fields` json DEFAULT NULL COMMENT '变更字段列表 [{field, old_value, new_value}]',
  `reason` text COLLATE utf8mb4_unicode_ci COMMENT '操作原因/备注',
  `is_reversible` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否可回滚（admin 域）',
  `reversal_data` json DEFAULT NULL COMMENT '回滚所需数据',
  ...
  `risk_level` enum('low','medium','high','critical') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'low' COMMENT '操作风险等级（admin 域）',
  `requires_approval` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否需要二次审批',
  `approval_status` enum('not_required','pending','approved','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_required' COMMENT '审批状态（admin 域）',
  `affected_users` int DEFAULT '0' COMMENT '影响用户数',
  `affected_amount` bigint DEFAULT '0' COMMENT '影响金额/积分数（分）',
  `rollback_deadline` datetime DEFAULT NULL COMMENT '回滚截止时间',
  `total_count` int DEFAULT NULL COMMENT '批量任务总操作数量（batch 域）',
  `success_count` int DEFAULT '0' COMMENT '批量任务成功数量（batch 域）',
  `fail_count` int DEFAULT '0' COMMENT '批量任务失败数量（batch 域）',
  `operation_params` json DEFAULT NULL COMMENT '批量任务参数JSON（batch 域）',
  `result_summary` json DEFAULT NULL COMMENT '批量任务结果摘要JSON（batch 域）',
  `completed_at` datetime DEFAULT NULL COMMENT '批量任务完成时间（batch 域）',
  `ip_address` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'IP地址（IPv4/IPv6）',
  `user_agent` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户代理字符串',
  `request_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '请求ID（全链路追踪）',
  `idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '幂等键（全局唯一，admin/batch 域必填）',
  `detail` json DEFAULT NULL COMMENT '域专有展示字段JSON（merchant: consumption_record_id/consumption_amount/error_message/extra_data；admin: target_type_raw）',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '操作时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间（仅 batch 域任务进度更新会变化）',
  PRIMARY KEY (`operation_log_id`),
  UNIQUE KEY `uk_operation_logs_idempotency_key` (`idempotency_key`),
  KEY `idx_operation_logs_domain_created` (`operator_type`,`created_at`),
  ...
  KEY `idx_operation_logs_store_created` (`store_id`,`created_at`),
  KEY `idx_operation_logs_domain_status` (`operator_type`,`status`),
  KEY `idx_operation_logs_risk_level` (`risk_level`),
  KEY `idx_operation_logs_reversible` (`is_reversible`,`is_reversed`),
  KEY `idx_operation_logs_request_id` (`request_id`),
  KEY `idx_operation_logs_ip` (`ip_address`),
  CONSTRAINT `operation_logs_ibfk_1` FOREIGN KEY (`operator_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `operation_logs_ibfk_2` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=311 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='统一操作日志表（admin/merchant/batch 三域合并，operator_type 多态）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prize_definitions` (
  ...
  CONSTRAINT `fk_prize_definitions_media` FOREIGN KEY (`primary_media_id`) REFERENCES `media_files` (`media_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='产品批次(一批一码;批次与系列号正交)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_bundles` (
  ...
  `bundle_type` enum('suit','gift') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'suit' COMMENT 'suit=套装/gift=赠品搭售',
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '状态',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间（北京时间）',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间（北京时间）',
  PRIMARY KEY (`bundle_id`),
  UNIQUE KEY `uk_bundle_spu` (`exchange_item_id`),
  CONSTRAINT `product_bundles_ibfk_1` FOREIGN KEY (`exchange_item_id`) REFERENCES `exchange_items` (`exchange_item_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='组合商品主体(S4,组合本身也是SPU)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='采购单明细行(S1)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6312 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='提醒历史记录表（存储每次提醒的触发和通知结果）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=288 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='水晶奖品倍率规则主表（绑定到具体抽奖活动，活动间隔离）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='倍率规则作用对象（仅引用现网人群标识；target_type=all 时本表无记录）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='门店员工关系表（员工-门店多对多，支持历史记录）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `suppliers` (
  ...
  `supplier_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '供应商名称（唯一，防运营重复建档）',
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='供货商主数据(区别于核销 merchants)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=490 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统字典表 - 存储各类枚举的中文显示名称映射';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统设置表：存储系统各模块的配置设置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户层级关系表（简化版：仅保留核心字段和必要索引）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13110 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户通知表 — 系统通知独立存储（方案B），永久保留交易凭证';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'restaurant_points_dev'
--

--
-- Dumping routines for database 'restaurant_points_dev'
--
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `CheckDataQuality` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `CheckDataQuality`()
BEGIN
        ...
        IF inconsistency_count > 0 THEN
          INSERT INTO data_quality_alerts (alert_type, message, created_at)
          VALUES ('orphaned_records', CONCAT('发现 ', inconsistency_count, ' 条孤立的抽奖记录'), NOW());
        END IF;
        ...
        IF inconsistency_count > 0 THEN
          INSERT INTO data_quality_alerts (alert_type, message, created_at)
          VALUES ('negative_points', CONCAT('发现 ', inconsistency_count, ' 个用户积分为负数'), NOW());
        END IF;
      END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2026-07-16  3:11:38
