...
(1,'餐厅消费回馈','CAMP20250901001','event',500,NULL,10000.00,10000.00,'{\"tiers\": [{\"weight\": 1000, \"tier_id\": 1, \"tier_name\": \"头号好礼\"}, {\"weight\": 9000, \"tier_id\": 2, \"tier_name\": \"尊享回馈\"}, {\"weight\": 90000, \"tier_id\": 3, \"tier_name\": \"优享回馈\"}, {\"weight\": 400000, \"tier_id\": 4, \"tier_name\": \"常享回馈\"}, {\"weight\": 500000, \"tier_id\": 5, \"tier_name\": \"基础礼遇\"}]}','2025-07-30 08:00:00','2026-12-09 07:59:00','00:00:00','','回馈好礼在您的消费回馈额度内随机发放，分高 / 中 / 低三档。实际可得档位受您的累计消费额度与近期获取情况影响，消费越多越有机会获得高档回馈。每次参与均会获得回馈，不存在\"未获得\"的情况。未成年人请在监护人指导下参与。','active','user','tier_first',1000000,10000,10000,'[\"CONSUMPTION_DEFAULT\"]',0,1225,6220,'2025-08-20 03:55:06','2026-07-16 02:37:37','{\"user_points\": {\"value\": 100, \"operator\": \">=\"}}','{\"user_points\": \"您的积分不足100分，快去消费获取积分吧！\"}','user_first',0.00,'on_demand',NULL,NULL,0.00,0,NULL,'golden_egg',4,'purple_mystery',1,'simple',0,0,0,NULL,NULL,NULL,'points');
