 ...
 */
router.get('/status', optionalAuth, dataAccessControl, asyncHandler(async (req, res) => {
 ...
 */
router.get('/business-config', optionalAuth, dataAccessControl, asyncHandler(async (req, res) => {
  // 读取代码层固定配置
