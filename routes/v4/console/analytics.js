 ...
 * @route GET /api/v4/console/analytics/decisions/analytics
 ...
 * @route GET /api/v4/console/analytics/lottery/trends
 * @access Private (需要管理员权限)
 */
router.get(
  '/lottery/trends',
 ...
 * @route GET /api/v4/console/analytics/performance/report
 * @access Private (需要管理员权限)
 */
router.get(
  '/performance/report',
 ...
 * @route GET /api/v4/console/analytics/stats/today
 * @access Private (需要管理员权限)
 */
router.get(
  '/stats/today',
