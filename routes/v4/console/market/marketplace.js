 ...
 *
 * @body {Array<number>} exchange_item_ids - 商品ID数组
 * @body {number} category_id - 目标分类ID
 *
 * @security JWT + Admin权限
 */
router.put(
 ...
 * @returns {number} data.active_items - 上架中商品数
 * @returns {number} data.low_stock_items - 低库存商品数
 * @returns {number} data.total_exchanges - 兑换总次数（不含已取消）
 *
 * @security JWT + Admin权限
 */
router.get(
