 ...
 */
router.get('/code/:code', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getItemTemplateService(req)
 ...
 * - is_enabled: 是否启用
 */
router.put('/batch/status', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getItemTemplateService(req)
