 ...
 */
router.get('/:id/attributes', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
 ...
 */
router.put('/:id/attributes', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getAttributeService(req)
