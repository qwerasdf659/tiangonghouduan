 ...
 * @route POST /api/v4/console/announcements
 ...
 * @route GET /api/v4/console/announcements
 * @access Private (需要管理员权限)
 */
router.get(
  '/',
 ...
 * @route PUT /api/v4/console/announcements/:id
 * @access Private (需要管理员权限)
 */
router.put(
  '/:id',
 ...
 *
 * @description 删除指定公告
 * @route DELETE /api/v4/console/announcements/:id
 * @access Private (需要管理员权限)
 */
router.delete(
  '/:id',
