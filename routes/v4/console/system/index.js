 ...
 * 管理后台 - 系统模块路由聚合入口
 *
 * @description 聚合系统监控、公告管理、反馈管理、审计日志相关路由
 * @version 5.1.0（2026-01-09 新增审计日志管理）
 * @date 2025-12-22
 * @updated 2026-01-09（新增审计日志管理模块）
 *
 * 模块结构：
 * - monitoring.js: 系统监控（/status, /dashboard, /management-status）
 * - announcements.js: 公告管理（CRUD）
 * - feedbacks.js: 反馈管理（列表、回复、状态更新）
 * - audit-logs.js: 审计日志管理（列表、详情、统计）
 *
 * 路由挂载说明：
...
router.use('/audit-logs', auditLogsRoutes) // 审计日志管理（2026-01-09 新增）
