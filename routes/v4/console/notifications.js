 ...
 *
 * @module routes/v4/console/notifications
 */
 ...
 * @route GET /api/v4/console/notifications/unread-count
 * @access Private（管理员）
 *
 ...
 * @route POST /api/v4/console/notifications/read-all
 * @access Private（管理员）
 */
router.post(
  '/read-all',
 ...
 * @route POST /api/v4/console/notifications/clear
 * @access Private（管理员）
 */
router.post(
  '/clear',
...
/**
 * POST /send - 管理员手动发送公告
 * @route POST /api/v4/console/notifications/send
 * @access Private（管理员）
...
/**
 * GET / - 获取通知列表
 * @route GET /api/v4/console/notifications
 * @access Private（管理员）
...
/**
 * GET /:id - 获取通知详情
 * @route GET /api/v4/console/notifications/:id
 * @access Private（管理员）
 */
router.get(
  '/:id',
 ...
 * @route POST /api/v4/console/notifications/:id/read
 * @access Private（管理员）
 */
router.post(
  '/:id/read',
 ...
 * @route DELETE /api/v4/console/notifications/:id
 * @access Private（管理员）
 */
router.delete(
  '/:id',
