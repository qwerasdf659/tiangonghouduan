 ...
 * }
 */
router.get('/records', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  // 🔄 通过 ServiceManager 获取 QueryService（V4.7.0 服务拆分）
  const QueryService = req.app.locals.services.getService('consumption_query')
 ...
 * }
 */
router.post('/approve/:id', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
 ...
 * }
 */
router.post('/batch-review', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
 ...
 * }
 */
router.post('/reject/:id', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const CoreService = req.app.locals.services.getService('consumption_core')
  const ApprovalChainService = req.app.locals.services.getService('approval_chain')
 ...
 */
router.get('/qrcode/:user_id', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
