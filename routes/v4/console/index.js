...
const exchangeItemRoutes = require('./exchange-items') // 兑换商品 SPU/SKU/渠道价
...
router.use('/exchange-items', exchangeItemRoutes) // 兑换商品与 SKU
  ...
  const adminInfo = {
    ...
    modules: {
      ...
      unified_product_center: {
        ...
        note: '管理后台商品主数据：categories 树、attributes 与选项、exchange_items 与 skus、exchange_channel_prices；requireRoleLevel(100)'
      },
      risk_profiles: {
