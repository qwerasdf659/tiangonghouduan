 ...
 */
router.get('/', authenticateToken, requireRoleLevel(1), asyncHandler(async (req, res) => {
 ...
 */
router.get('/stats', authenticateToken, requireRoleLevel(1), asyncHandler(async (req, res) => {
  const TradeDisputeService = req.app.locals.services.getService('trade_dispute')
 ...
 */
router.get('/:id', authenticateToken, requireRoleLevel(1), asyncHandler(async (req, res) => {
  const TradeDisputeService = req.app.locals.services.getService('trade_dispute')
 ...
 */
router.post('/', authenticateToken, requireRoleLevel(50), asyncHandler(async (req, res) => {
  const TradeDisputeService = req.app.locals.services.getService('trade_dispute')
 ...
 */
router.post('/:id/escalate', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const TradeDisputeService = req.app.locals.services.getService('trade_dispute')
 ...
 */
router.post('/:id/resolve', authenticateToken, requireRoleLevel(50), asyncHandler(async (req, res) => {
  const TradeDisputeService = req.app.locals.services.getService('trade_dispute')
