 ...
 */
router.get('/templates', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
 ...
 * @access admin(role_level >= 100)
 */
router.get('/templates/:id', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 */
router.post('/templates', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 * @access admin(role_level >= 100)
 */
router.put('/templates/:id', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 * @access admin(role_level >= 100)
 */
router.put('/templates/:id/toggle', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
  const templateId = parseInt(req.params.id, 10)
  const result = await TransactionManager.execute(
    async transaction => {
 ...
 */
router.get('/instances', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 */
router.get('/instances/by-auditable', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 * @access business_manager(role_level >= 60)
 */
router.get('/instances/:id', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 */
router.get('/role-pending', authenticateToken, requireRoleLevel(100), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 * @access business_manager(role_level >= 60)
 */
router.get('/my-pending', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 */
router.post('/steps/:id/approve', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
 ...
 */
router.post('/steps/:id/reject', authenticateToken, requireRoleLevel(60), asyncHandler(async (req, res) => {
  const service = getApprovalChainService(req)
  const stepId = parseInt(req.params.id, 10)
  const { reason } = req.body
