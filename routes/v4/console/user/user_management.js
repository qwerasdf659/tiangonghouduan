 ...
 * @since 2026
 */
router.get('/users/resolve', asyncHandler(async (req, res) => {
 ...
 */
router.get('/users/:user_id', asyncHandler(async (req, res) => {
 ...
 */
router.put('/users/:user_id/role', asyncHandler(async (req, res) => {
  const { user_id } = req.params
 ...
 */
router.put('/users/:user_id/status', asyncHandler(async (req, res) => {
  const { user_id } = req.params
 ...
 * @since 2026
 */
router.put('/roles/:role_id', asyncHandler(async (req, res) => {
 ...
 * @since 2026
 */
router.delete('/roles/:role_id', asyncHandler(async (req, res) => {
  const { role_id } = req.params
  const operatorId = req.user.user_id
 ...
 * @since 2026
 */
router.get('/permission-resources', asyncHandler(async (req, res) => {
  // 通过 ServiceManager 获取 RoleManagementService
  const RoleManagementService = req.app.locals.services.getService('role_management')
