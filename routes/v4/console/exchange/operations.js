...
router.put('/items/batch-price', authenticateToken, requireRoleLevel(100), async (req, res) => {
  try {
...
router.get('/missing-images', authenticateToken, requireRoleLevel(100), async (req, res) => {
  try {
