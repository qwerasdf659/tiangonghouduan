 ...
 * @route GET /api/v4/admin/popup-banners
 ...
 * @route GET /api/v4/admin/popup-banners/statistics
 * @access Private (需要管理员权限)
 */
router.get(
  '/statistics',
 ...
 * @route GET /api/v4/admin/popup-banners/:id
 * @access Private (需要管理员权限)
 */
router.get(
  '/:id',
 ...
 * @route POST /api/v4/admin/popup-banners
 * @access Private (需要管理员权限)
 *
 ...
 * @route PUT /api/v4/admin/popup-banners/:id
 * @access Private (需要管理员权限)
 */
router.put(
  '/:id',
 ...
 *
 * @description 删除指定弹窗
 * @route DELETE /api/v4/admin/popup-banners/:id
 * @access Private (需要管理员权限)
 */
router.delete(
  '/:id',
 ...
 * @route PATCH /api/v4/admin/popup-banners/:id/toggle
 * @access Private (需要管理员权限)
 */
router.patch(
  '/:id/toggle',
 ...
 * @route PATCH /api/v4/admin/popup-banners/order
 * @access Private (需要管理员权限)
 *
