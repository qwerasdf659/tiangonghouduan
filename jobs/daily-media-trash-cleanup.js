 ...
 *
 * @description
 *   自动物理删除 media_files 中 status='trashed' 且 trashed_at 超过 30 天的记录
 ...
 *   - 清理条件：status='trashed' AND trashed_at < (now - 30天)
...
class DailyMediaTrashCleanup {
   ...
   * 执行回收站清理任务
   *
   * @param {number} [days=30] - 回收站保留天数，超过此天数的记录将被物理删除
